...
-   **sfdep**: performing geospatia data wrangling and local colocation quotient analysis
...
```{r}
pacman::p_load(tmap, tidyverse, sf, funModeling, sfdep, spatstat, maptools, raster)
```
...
-   summarises information of small zones compared to other zones 
